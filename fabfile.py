"""
Starter fabfile for deploying the web_dja project.
...
# CHANGEME
env.hosts = ['user@web_dja.example.com']
env.code_dir = '/srv/www/web_dja'
env.project_dir = '/srv/www/web_dja/web_dja'
env.static_root = '/srv/www/web_dja/static/'
env.virtualenv = '/srv/www/web_dja/.virtualenv'
env.code_repo = 'git@github.com:user/web_dja.git'
env.django_settings_module = 'web_dja.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/web_dja/wsgi.py" % env.code_dir)
