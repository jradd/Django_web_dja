...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'web_dja.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'web_dja.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[web_dja]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_web_dja"  # Make this unique to your project.
